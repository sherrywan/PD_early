...
LastEditTime: 2024-07-02 19:46:33
...
model_path = "/data0/wxy/PD/PD_early/res/checkpoints/train_RF.ckpt"
...
plt.show()
plt.savefig("/data0/wxy/PD/PD_early/res/checkpoints/train_RF_feature_importances.png")
plt.cla()
plt.close()
...
plt.show()
plt.savefig("/data0/wxy/PD/PD_early/res/checkpoints/train_RF_module_feature_importances.png")